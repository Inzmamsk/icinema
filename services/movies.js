...
// const { getMovieByTitle } = require('../controller/Omdb/index');

// async function fetchAllMovies(query) {
//     console.log(query, "qqqqqqqqqquuuuuuuuuuuuuueeeeeeeeerrrrrrrrryyyyyyyyyy");
//     console.log(movies, "qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq");
